                ...
                <div class="card-body" id="print">
                    ...
                    <div class="row mg-t-20">
                        <div class="col-md">
                            ...
                            <p class="h-5">عنوان العميل : {{ $order->address }}</p>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($order->orderItems as $product)
                                    <tr>
                                        ...
                                        <td></td>
                                        {{-- <td class="text-center"><img src="{{ $product->product->im }}"
                                                style="width:50px;height:50px" alt=""></td> --}}
                                        <td class="text-center">{{ $product->quantity }}</td>
                                        <td class="text-center">{{ $product->price }} ريال</td>

                                        <td class="text-center">{{ $product->quantity * $product->price }}
                                            ريال</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    ...
                                    <td class="text-right">خدمة التوصيل</td>
                                    <td class="text-center" colspan="3">{{ $order->tax }} ريال.</td>
                                </tr>
                                <tr>
                                    <td class="valign-middle" colspan="4">
                                        <div class="invoice-notes">
                                    ...
                                    <td class="text-center" colspan="2">{{ $order->total }} ريال</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
