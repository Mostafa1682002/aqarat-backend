                    ...
                    <div class="main-form-aosh">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="input-form">
                                ...
                                <input type="text" placeholder="الاسم كاملا" class="form-control" name="name"
                            ...
                            <div class="input-form">
                                ...
                                <input type="text" placeholder="رقم الجوال" class="form-control" name="phone"
                            ...
                            <div class="check-aosh">
                                <input type="checkbox" id="check-1" required>
                                <label for="check-1">تسجيل الحساب بمثابة الموافقة على الشروط والأحكام </label>
                            </div>

                            <div class="btn-aosh">
                                <button type="submit" class="ctm-btn w-100 mt-4">انشاء حساب</button>
                            </div>
                            <div class="links-aosh">
                                <p>لديك حساب؟ <a href="{{ route('login') }}"> تسجيل دخول </a> </p>
                            </div>
                        </form>
                    </div>
                </div>
